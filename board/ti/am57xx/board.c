...
#ifdef CONFIG_JN_MINI5728
    #define BOARD_NAME "JN-mini5728"
    #define PADCONF_ARRAY core_padconf_array_JN_mini5728
    #include "JN-mini5728_mux_data.h"
#elif CONFIG_JN_SG300
    #define BOARD_NAME "JN-SG300"
    #define PADCONF_ARRAY core_padconf_array_JN_SG300
    #include "JN-SG300_mux_data.h"
#else
